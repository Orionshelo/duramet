...
<body>
    ...
    <section class="alquiler-hero">
        ...
        <a href="https://wa.me/573103489282?text=Hola%2C%20necesito%20alquilar%20un%20equipo" target="_blank" class="btn-hero-primary">Solicitar Cotización</a>
    </section>
    ...
    <div class="equipment-grid">
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<a href='https://wa.me/573103489282?text=Hola%2C%20me%20interesa%20" . urlencode($row['nombre']) . "' target='_blank' class='btn-whatsapp-equip'>Cotizar</a>";
                echo "</div>";
                echo "</div>";
                echo "</div>";
            }
    ...
    <a href="https://wa.me/573103489282?text=Hola%2C%20quiero%20información%20sobre%20equipos" target="_blank" class="whatsapp-float" aria-label="Contactar por WhatsApp">
